...
import { SQLiteCloudCommand, type SQLCloudRowsetMetadata, type SQLiteCloudDataTypes, type SQLiteCloudSafeIntegerMode } from './types';
...
export declare function parseArray(buffer: Buffer, spaceIndex: number, safeIntegerMode?: SQLiteCloudSafeIntegerMode): SQLiteCloudDataTypes[];
 ...
 */
export declare function parseRowsetChunks(buffers: Buffer[], safeIntegerMode?: SQLiteCloudSafeIntegerMode): SQLiteCloudRowset;
/** Parse command, extract its data, return the data and the buffer moved to the first byte after the command */
export declare function popData(buffer: Buffer, safeIntegerMode?: SQLiteCloudSafeIntegerMode): {
