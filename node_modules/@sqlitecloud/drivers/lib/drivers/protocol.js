...
function parseArray(buffer, spaceIndex, safeIntegerMode = types_1.SAFE_INTEGER_MODE) {
    const parsedData = [];
...
function parseRowsetColumnsMetadata(buffer, metadata, safeIntegerMode) {
    function popForward() {
...
function parseRowset(buffer, spaceIndex, safeIntegerMode) {
 ...
 */
function parseRowsetChunks(buffers, safeIntegerMode = types_1.SAFE_INTEGER_MODE) {
...
function popData(buffer, safeIntegerMode = types_1.SAFE_INTEGER_MODE) {
