...
export declare let SAFE_INTEGER_MODE: SQLiteCloudSafeIntegerMode;
export declare const DEFAULT_WEBSOCKET_BLOB_TRANSFER_FORMAT: SQLiteCloudWebsocketBlobTransferFormat;
export declare const DEFAULT_WEBSOCKET_MAX_ATTACHMENTS = 100000;
/**
